...
ColorScheme dojoColorScheme = ColorScheme(
    primary: Color(0xffEB0A11),
    primaryVariant: Color(0xffB0070D),
    secondary: Color(0xff161B30),
    secondaryVariant: Color(0xff0D101C),
...
final ThemeData dojoTheme = ThemeData(
...
// Use below list for reference when attempting to customize theme parameters.
