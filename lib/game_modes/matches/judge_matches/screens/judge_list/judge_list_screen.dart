...
import 'package:dojo_app/widgets/judge_card_matches.dart';
...
class _JudgeListScreenState extends State<JudgeListScreen> {
  ...
  String nickname = globalsMatches.judgeListWrapperMap['nickname'];
  String userID = globalsMatches.judgeListWrapperMap['userID'];
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return JudgeCard(
                                            ...
                                            avatarFirstLetter: 'M',
                                            title: '${listOfMatchesOpenForJudging[index]['playerNicknames'][playerOneUserID]} vs ${listOfMatchesOpenForJudging[index]['playerNicknames'][playerTwoUserID]}',
                                            gameID: '${listOfMatchesOpenForJudging[index]['gameID']}',
                                            playerOneNickname: '${listOfMatchesOpenForJudging[index]['playerNicknames'][playerOneUserID]}',
                                            playerOneScore: '${listOfMatchesOpenForJudging[index]['playerScores'][playerOneUserID]}',
                                            playerOneVideo: '${listOfMatchesOpenForJudging[index]['playerVideos'][playerOneUserID]}',
                                            playerTwoNickname: '${listOfMatchesOpenForJudging[index]['playerNicknames'][playerTwoUserID]}',
                                            playerTwoScore: '${listOfMatchesOpenForJudging[index]['playerScores'][playerTwoUserID]}',
                                            playerTwoVideo: '${listOfMatchesOpenForJudging[index]['playerVideos'][playerTwoUserID]}',
